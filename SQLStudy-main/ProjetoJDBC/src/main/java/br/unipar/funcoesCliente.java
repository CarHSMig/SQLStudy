...
public class funcoesCliente {
    ...
    public static void inserirCliente(String nome, String cpf) {
        try {
            ...
            PreparedStatement preparedStatement = conn.prepareStatement("INSERT INTO cliente (nome, cpf) VALUES(?,?)");
    ...
    public static void listarTodosClientes() {
        try {
            ...
            while (result.next()) {
                System.out.println(result.getInt("id_cliente") + ", " + result.getString("nome") + ", " + result.getString("cpf"));
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public static void alterarCliente() {
        ...
        System.out.println("Escreva o novo nome do cliente:");
        String novoNome = input.nextLine();

        System.out.println("Escreva o novo CPF do cliente:");
        String novoCpf = input.nextLine();

        try {
            atualizarCliente(id_cliente, novoNome, novoCpf);
        } catch (RuntimeException e) {
            System.err.println("Erro ao atualizar cliente: " + e.getMessage());
        }
    }

    public static void atualizarCliente(int id_cliente, String novoNome, String novoCpf) {
        try {
            Connection conn = connection();
            PreparedStatement preparedStatement = conn.prepareStatement("UPDATE cliente SET nome = ?, cpf = ? WHERE id_cliente = ?");
